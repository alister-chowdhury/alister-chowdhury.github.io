...
// alister-chowdhury change BEGIN: Remove vector include
// #include <vector>
// alister-chowdhury change END: Remove vector include
...
// alister-chowdhury change BEGIN: pointer cast
			std::sort((int*)dots, dots + 16);
// alister-chowdhury change END: pointer cast
