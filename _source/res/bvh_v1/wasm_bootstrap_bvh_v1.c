...
LineBvhV1Result globalTraceResult;

WASM_EXPORT LineBvhV1Result* getTraceResultData() { return &globalTraceResult; }
WASM_EXPORT int traceBvh(float roX, float roY,
                         float rdX, float rdY,
                         float maxDist,
                         int stopOnFirstHit)
{
    ...
    return globalTraceResult.hitLineId != 0xffffffffu;
}
