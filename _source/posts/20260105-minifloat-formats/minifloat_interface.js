...
const minifloat = WebAssembly.instantiateStreaming(fetch("/res/minifloat.wasm")).then(
    ...
    return {
        ...
        e4m3fnuz_to_f32: wasm_funcs.e4m3fnuz_to_f32_,
...
export const minifloatInterface = minifloat.then( funcs => {
    ...
    const e5m2fnuz = {
        ...
        num_bits: 8,
        exp_bias: 1,
        to_f32: funcs.e5m2fnuz_to_f32,
        from_f32: funcs.f32_to_e5m2fnuz
    };
    ...
    const e4m3fnuz = {
        ...
        num_bits: 8,
        exp_bias: 1,
        to_f32: funcs.e4m3fnuz_to_f32,
        from_f32: funcs.f32_to_e4m3fnuz
    };
    ...
    const e8m0 = {
        ...
        num_bits: 8,
        no_subnormals: true,
        to_f32: funcs.e8m0_to_f32,
        from_f32: funcs.f32_to_e8m0
    };
...
*/
    ...
    const breakdown = (v, interface_) => {
        ...
        const subnormal = (e == 0) && !interface_.no_subnormals;
        const e_val = (e + subnormal) - Math.floor(e_mask / 2) - (interface_.exp_bias || 0);
