...
void main()
{
    ...
    float _230 = float((_247 ^ (_247 >> uint(15))) & 65535u);
    vec3 _277 = clamp(vec3(abs(_230 * 9.15541313588619232177734375e-05 + (-3.0)) - 1.0, 2.0 - abs(_230 * 9.15541313588619232177734375e-05 + (-2.0)), 2.0 - abs(_230 * 9.15541313588619232177734375e-05 + (-4.0))), vec3(0.0), vec3(1.0));
    vec3 _281;
    if (_171)
    {
        _281 = _277 * 2.0;
