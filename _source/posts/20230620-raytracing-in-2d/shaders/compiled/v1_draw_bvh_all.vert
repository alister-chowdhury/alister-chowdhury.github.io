...
void main()
{
    ...
    float _317 = float((_305 ^ (_305 >> uint(15))) & 65535u) * 9.15541313588619232177734375e-05;
    vec3 _335 = clamp(vec3(abs(_317 - 3.0) - 1.0, 2.0 - abs(_317 - 2.0), 2.0 - abs(_317 - 4.0)), vec3(0.0), vec3(1.0));
    vec3 _343;
    if (_171)
    {
        _343 = _335 * 2.0;
