...
void main()
{
    ...
    float _303 = float((_291 ^ (_291 >> uint(15))) & 65535u) * 9.15541313588619232177734375e-05;
    vec3 _321 = clamp(vec3(abs(_303 - 3.0) - 1.0, 2.0 - abs(_303 - 2.0), 2.0 - abs(_303 - 4.0)), vec3(0.0), vec3(1.0));
    vec3 _329;
    if (_171)
    {
        _329 = _321 * 2.0;
