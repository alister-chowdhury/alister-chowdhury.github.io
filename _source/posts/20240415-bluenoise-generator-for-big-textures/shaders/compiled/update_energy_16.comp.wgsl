...
fn main_1() {
    ...
    let _e31 = _7_;
    let _e35 = _7_;
    _61_ = (((_e24 / vec2(2i)) * vec2(2i)) + bitcast<vec2<i32>>(_e35._m0_._m0_.xy));
    let _e43 = _58_;
    let _e50 = gl_LocalInvocationID;
    _67_ = (((_e43 % vec2(2i)) * vec2(8i)) + vec2<i32>(_e50.xy));
    let _e55 = _67_;
    _68_ = vec2<f32>(_e55);
    let _e58 = _54_;
    _70_ = _e58.x;
    ...
    let _e70 = _67_;
    let _e75 = _67_;
    _79_ = (((((_e61.y * _e63) + _e65.x) * 256i) + (_e70.y * 16i)) + _e75.x);
    _81_ = 0f;
    loop {
        let _e85 = _84_;
        if !((_e85 <= 1i)) {
        ...
        }
        {
            ...
            loop {
                ...
                }
                {
                    ...
                    let _e192 = _68_;
                    _141_ = (((vec2<f32>(f32(_e179), f32(_e181)) * 16f) + _e189.xy) - _e192);
                    let _e197 = _141_;
                    let _e198 = _141_;
                    let _e201 = _7_;
                    let _e208 = _141_;
